...
import AnimationCascadeList from "@/app/role-teacher/content/AnimationCascadeList"
import ComponentAddModuleButton from "@/app/role-teacher/content/ComponentAddModuleButton"

export default function ComponentContentList({ onModuleSelect, defaultCourseId }) {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        let taskcode
        taskcode = await getAllTaskCodes()
        ...
        if (defaultCourse) {
          const courseModules = await getAllTaskCodes(defaultCourse.id)
          if (!isMounted) return
